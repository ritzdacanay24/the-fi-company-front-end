...
@Component({
  ...
  selector: 'app-expense-report-chart',
  templateUrl: `./expense-report-chart.component.html`,
})
export class ExpenseReportChartComponent implements OnInit {
