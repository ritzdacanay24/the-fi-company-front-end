...
export class NcrListComponent implements OnInit {
  ...
  columnDefs: (ColDef | ColGroupDef)[] = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          field: "ca_iss_to",
          headerName: "CA Issued To",
          filter: "agSetColumnFilter",
        },
        {
          field: "ca_due_dt",
          headerName: "CA Issued Due Date",
          filter: "agTextColumnFilter",
        },
        {
          field: "ca_action_req",
        ...
        {
          field: "planned_ca_impl_dt",
          headerName: "Planned Implementation Date ",
          filter: "agTextColumnFilter",
        },
        ...
        {
          field: "ca_impl_title",
          headerName: "Implementation Title",
          filter: "agTextColumnFilter",
        },
        {
          field: "ca_impl_dt",
    ...
    },
    {
      ...
      children: [
        ...
        {
          field: "verif_of_ca_by",
          headerName: "Verified By",
          filter: "agTextColumnFilter",
        },
        {
          field: "verif_of_ca_dt",
          headerName: "Verified Date",
          filter: "agTextColumnFilter",
        },
        {
          field: "eff_verif_of_ca_by",
          headerName: "Effectiveness Verification of CA By",
          filter: "agTextColumnFilter",
        },
        {
          field: "eff_verif_of_ca_dt",
          headerName: "Effectiveness Verification of CA Date",
          filter: "agTextColumnFilter",
        },
        {
          field: "cmt_cls_by",
          headerName: "Comments/Closure By",
          filter: "agTextColumnFilter",
        },
        {
          field: "cmt_cls_dt",
          headerName: "Comments/Closure Date",
          filter: "agTextColumnFilter",
        },
      ],
    },
  ...
  selectJohnAndKenny(department) {
    if (department == "All") {
      ...
      this.gridApi!.setColumnFilterModel("ca_iss_to", {
        values: [department],
      }).then(() => {
        this.gridApi!.onFilterChanged();
      });
