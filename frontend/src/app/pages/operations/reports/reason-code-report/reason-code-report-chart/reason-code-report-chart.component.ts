...
@Component({
  ...
  selector: 'app-reason-code-report-chart',
  templateUrl: `./reason-code-report-chart.component.html`,
})
export class ReasonCodeReportChartReportChartComponent implements OnInit {
