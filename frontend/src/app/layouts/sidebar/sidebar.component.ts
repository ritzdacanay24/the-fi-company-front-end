...
export class SidebarComponent implements OnInit {
  private readonly badgeKeys = new Set<keyof SidebarMenuBadgeCounts>([
    ...
    'forkliftInspectionPendingResolutions',
    'shortagesOpen',
    'safetyIncidentOpen',
    'qualityIssuesOpen',
  ...
  private readonly badgeVariantByKey: Record<keyof SidebarMenuBadgeCounts, string> = {
    ...
    forkliftInspectionPendingResolutions: 'sidebar-count-badge--critical',
    ...
    fieldServiceJobsOpen: 'sidebar-count-badge--critical',
    ...
    inspectionChecklistTemplatesDraft: 'sidebar-count-badge--warning',
