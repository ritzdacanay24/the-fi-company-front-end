...
### 2. Frontend Service Updates (`frontend/src/app/core/services/serial-number.service.ts`)
...
### 3. Component Updates (`frontend/src/app/shared/components/serial-number-generator/serial-number-generator.component.ts`)
...
### 4. Template Updates (`frontend/src/app/shared/components/serial-number-generator/serial-number-generator.component.html`)
