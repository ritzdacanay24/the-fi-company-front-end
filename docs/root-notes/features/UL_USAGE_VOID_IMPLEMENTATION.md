...
### Service (`frontend/src/app/features/ul-management/services/ul-label.service.ts`)
...
### Database Migration (`backend/database/migrations/add_ul_usage_void_columns.sql`)
...
2. `frontend/src/app/features/ul-management/services/ul-label.service.ts` - Added voidULLabelUsage method
3. `frontend/src/app/features/ul-management/components/ul-usage-report/ul-usage-report.component.ts` - Full void UI
4. `frontend/src/app/features/ul-management/components/ul-usage-report/ul-usage-report.component.html` - Modals
5. `backend/database/migrations/add_ul_usage_void_columns.sql` - Schema changes
