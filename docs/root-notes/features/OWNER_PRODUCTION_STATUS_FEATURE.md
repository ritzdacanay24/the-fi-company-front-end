...
### Migration File
- **Location**: `backend/database/migrations/add_is_production_to_owners.sql`
...
source backend/database/migrations/add_is_production_to_owners.sql;
```
...
- **File**: `frontend/src/app/core/api/owners/owners.service.ts`
- **Added**: `is_production?: boolean` field to `Owner` interface

### 2. Owner Management Modal
- **File**: `frontend/src/app/shared/components/owner-management-modal/owner-management-modal.component.ts`
...
- **File**: `frontend/src/app/standalone/shipping-priority-display/components/multi-card-view/`
