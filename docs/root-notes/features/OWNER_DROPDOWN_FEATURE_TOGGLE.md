...
**Migration File**: `backend/database/migrations/create_system_settings_table.sql`

Run this SQL to create the table:
```sql
mysql -u your_user -p your_database < backend/database/migrations/create_system_settings_table.sql
```
...
### Service Methods Added (`frontend/src/app/core/api/owners/owners.service.ts`)
