...
**File:** `frontend/src/app/pages/operations/master-scheduling/master-production/master-production.component.ts`
...
- Database Schema: `backend/database/migrations/add_kanban_priority.sql`
- Backend API: `backend/api/kanban-priorities/index.php`
- Service Methods: `frontend/src/app/core/api/operations/master-scheduling/master-scheduling.service.ts`
- Component: `frontend/src/app/pages/operations/master-scheduling/master-production/master-production.component.ts`
