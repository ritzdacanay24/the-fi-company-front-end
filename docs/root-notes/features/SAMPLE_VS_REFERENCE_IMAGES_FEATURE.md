...
### 1. Database Schema (`backend/database/migrations/add_image_type_to_sample_images.sql`)
...
### 3. Template Editor UI (`frontend/src/app/pages/quality/checklist/template-editor/checklist-template-editor.component.ts`)
...
### 4. Template Preview Modal (`frontend/src/app/pages/quality/checklist/checklist.component.html`)
...
1. `backend/database/migrations/add_image_type_to_sample_images.sql` - Schema documentation
2. `backend/api/photo-checklist/photo-checklist-config.php` - Validation logic
3. `frontend/src/app/pages/quality/checklist/template-editor/checklist-template-editor.component.ts` - Editor UI and logic
4. `frontend/src/app/pages/quality/checklist/checklist.component.html` - Preview modal
5. `frontend/src/app/pages/quality/checklist/checklist.component.ts` - Helper methods
