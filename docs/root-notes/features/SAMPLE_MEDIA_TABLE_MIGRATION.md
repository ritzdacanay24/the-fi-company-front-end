...
### Migration File
**Location**: `backend/database/migrations/create_checklist_item_sample_media_table.sql`
...
**To apply migration**:
```bash
mysql -u your_user -p your_database < backend/database/migrations/create_checklist_item_sample_media_table.sql
```
...
### New Files
- `backend/database/migrations/create_checklist_item_sample_media_table.sql`
