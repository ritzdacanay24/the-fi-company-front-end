...
check_file "backend/database/migrations/create_photo_checklist_tables.sql"
check_file "backend/igt_api/photo-checklist-config.php"
check_file "backend/php/config/database.php"
echo "✓ All required files found"

echo ""
echo "Step 2: Setting up database schema..."
run_sql_file "backend/database/migrations/create_photo_checklist_tables.sql"
...
if [ -f "backend/igt_api/photo-checklist-config.php" ]; then
    chmod 644 "backend/igt_api/photo-checklist-config.php"
...
mkdir -p "backend/php/uploads/photos"
chmod 755 "backend/php/uploads/photos"
