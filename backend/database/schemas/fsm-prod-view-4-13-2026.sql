...
CREATE TABLE IF NOT EXISTS `fs_client_det` (
  ...
  `active` int(11) NOT NULL DEFAULT '1',
  `fs_client_settings_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fs_det_id` (`fs_det_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11860 DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS `fs_client_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `first_name` varchar(50) DEFAULT NULL,
  `last_name` varchar(50) DEFAULT NULL,
  `active` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `fs_det` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fs_mstr_id` int(11) NOT NULL,
  `req_dt` varchar(200) NOT NULL,
  ...
  `co_nbr` varchar(100) DEFAULT NULL,
  `comp_lic_notes` varchar(800) DEFAULT NULL,
  `hrly_rate` decimal(10,2) NOT NULL COMMENT 'hourly rate',
  `hrly_ot_rate` decimal(10,2) NOT NULL COMMENT 'hourly overtime rate',
  `mark_up_percent` decimal(10,2) NOT NULL,
  `published` int(11) DEFAULT '0',
  `company` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fs_mstr_id` (`fs_mstr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17490 DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS `fs_event_det` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `start` datetime DEFAULT NULL,
  `title` varchar(150) NOT NULL,
  `end` time DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `allDay` varchar(5) NOT NULL DEFAULT 'Yes',
  ...
  `fs_det_id` int(11) DEFAULT NULL,
  `border_color` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=620 DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS `fs_inv_det` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vendor_inv_nbr` varchar(100) DEFAULT NULL,
  `vendor_cost` varchar(50) DEFAULT NULL,
  `invoice_date` date DEFAULT NULL,
  `inv_nbr` varchar(100) DEFAULT NULL,
  `acc_status` varchar(20) DEFAULT NULL,
  `billable_flat_rate_or_po` varchar(20) DEFAULT NULL,
  `paperwork_loc` varchar(100) DEFAULT NULL,
  `contract_inv_sent_to_ap` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `fs_platform_det` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fs_det_id` int(11) NOT NULL,
  `sign_theme` varchar(150) DEFAULT NULL,
  `sign_type` varchar(150) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `fs_property_det` (
  ...
  `property_phone_nbr` varchar(50) DEFAULT NULL,
  `comments` varchar(200) DEFAULT NULL,
  `active` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `fs_det_id` (`fs_det_id`),
  KEY `fs_det_id_2` (`fs_det_id`),
  KEY `fs_det_id_3` (`fs_det_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3670 DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS `fs_property_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `property` varchar(300) NOT NULL,
  `address1` varchar(300) DEFAULT NULL,
  `address2` varchar(300) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `fs_team` (
  ...
  `active` int(11) NOT NULL DEFAULT '1',
  `lead_tech` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fs_det_id` (`fs_det_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8500 DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS `fs_turnover` (
  `1` int(11) NOT NULL AUTO_INCREMENT,
  `fs_det_id` int(11) NOT NULL,
  PRIMARY KEY (`1`),
  UNIQUE KEY `1` (`1`),
  KEY `fk_fs_det_id` (`fs_det_id`)
