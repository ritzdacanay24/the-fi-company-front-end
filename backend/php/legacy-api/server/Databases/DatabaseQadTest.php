<?php 
	...
	class DatabaseQadTest {
		...
		public function __construct($obj = null) {
            ...
            $this->host = getenv('QAD_HOST_TEST');
		...
		public function run_options($obj) {
            ...
            if(ISSET($obj['protection']) && $obj['protection']){
                $this->protected();
            } 
        ...
        public function getConnection() {
            ...
            if($this->protected || $this->protectAll){
                $this->protected();
            }
	...
	public function set_host($host){
        ...
        /**
         * Dump data coldfusion way
         * 
         * @param mixed $data can be in any format
         */
        public function dump($data)
        {
            include DOCUMENT_ROOT . '/test/dump.php';
            return phDump($data);
        }

        /**
         * Print data without the objects
         * 
        ...
        /**
         * Create query, prepare and execute statment
         * 
         * @param $sql Sql statment
         * @param $args $key->$value
         * 
         * @return $stmt the object
         */
        ...
        /**
         * This method prints all the methods, arguments, and comments for a given class
         * 
         * @param string $mgr The class name
         * @param bool $closeAfter should die after running this method
         * @param bool $display to show methods and arguments
         * 
         * @return void
        */
        public function print_object_methods($mgr, $closeAfter = false, $display = false)
        {
            if(!$display){
                return;
            }
            ...
            $l = "Class name: " . $r->getName();
            $l .= "<ul style='font-size:.9em;'>";
            foreach ( get_class_methods( $mgr ) as $method ) {
                ...
                if ( ! empty( $params ) ) {
                    ...
                    $l .= sprintf( '( %s )', implode(', ', $param_names ) );
                }
                
                $l .= "<ul>";
                $l .= '<li><pre style="white-space: pre-line;">' . $r->getDocComment() . "</pre></li>";
                $l .= "</ul>";
                $l .= "</li>";
