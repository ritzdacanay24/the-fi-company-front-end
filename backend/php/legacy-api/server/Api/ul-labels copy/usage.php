...
class ULUsageAPI {
    ...
    public function create($data) {
        try {
            ...
            $customer_name = isset($data['customer_name']) ? trim($data['customer_name']) : null; // Now optional
    ...
    public function update($id, $data) {
        try {
            ...
            $customer_name = isset($data['customer_name']) ? trim($data['customer_name']) : null; // Optional
