...
use PHPMailer\PHPMailer\PHPMailer;
    ...
    $emailUsers = emailNotification('lnw_shipping_report_notification');

    
    $ccEmails = emailNotification('lnw_shipping_report_notification_cc');

    $ee = implode(', ', $dateSearchArray);
    $mail = new PHPMailer(true);
    $mail->isHTML(true);
        $mail->CharSet = 'UTF-8';
    $mail->setFrom('noreply@the-fi-company.com', 'DB The-Fi-Company');
    $mail->Subject = "LNW DELIVERY " . $ee;
    ...
    $mail->Body .= '<br><br>';
    $mail->Body .= 'Below is what we have on the schedule for ' . $ee;
    $mail->Body .= '<br><br>';
