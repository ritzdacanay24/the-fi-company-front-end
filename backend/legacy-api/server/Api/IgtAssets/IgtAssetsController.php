...
class IgtAssets
{
        ...
        try {
            ...
            $query = "
                INSERT INTO igt_assets (
                    generated_IGT_asset, serial_number, wo_number, property_site,
                    igt_part_number, eyefi_part_number, inspector_name, 
            ...
            $stmt->bindParam(':generated_IGT_asset', $data['generated_IGT_asset'], PDO::PARAM_STR);
            $stmt->bindParam(':serial_number', $data['serial_number'], PDO::PARAM_STR);
            $stmt->bindParam(':wo_number', $data['wo_number'], PDO::PARAM_STR);
            $stmt->bindParam(':property_site', $data['property_site'], PDO::PARAM_STR);
            $stmt->bindParam(':igt_part_number', $data['igt_part_number'], PDO::PARAM_STR);
            $stmt->bindParam(':eyefi_part_number', $data['eyefi_part_number'], PDO::PARAM_STR);
            $stmt->bindParam(':inspector_name', $data['inspector_name'], PDO::PARAM_STR);
            $stmt->bindParam(':notes', $data['notes'], PDO::PARAM_STR);
            $stmt->bindParam(':created_by', $data['created_by'], PDO::PARAM_STR);
            $stmt->bindParam(':serial_number_id', $serialNumberRecord['id'], PDO::PARAM_INT);
            ...
            $this->db->commit();
            return ['id' => $assetId, 'showPopup' => false];

        } catch (PDOException $e) {
            $this->db->rollback();
            return ['error' => 'Error creating IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            $this->db->rollback();
            return ['error' => 'Error creating IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        }
    ...
    public function getById($id)
    {
        try {
            ...
            return $stmt->fetch(PDO::FETCH_ASSOC) + ['showPopup' => false];

        } catch (PDOException $e) {
            return ['error' => 'Error fetching IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            return ['error' => 'Error fetching IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        }
    }
     ...
     */
    public function getAll($filters = [], $page = 1, $limit = 5000)
    {
        try {
            ...
            return ['error' => 'Error fetching IGT assets: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            return ['error' => 'Error fetching IGT assets: ' . $e->getMessage(), 'showPopup' => false];
        }
    }
    ...
    public function update($id, $data)
    {
        try {
            ...
            return ['error' => 'Error updating IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            return ['error' => 'Error updating IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        }
    }
    ...
    public function delete($id, $deletedBy)
    {
        try {
            ...
            return ['error' => 'Error deleting IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            return ['error' => 'Error deleting IGT asset: ' . $e->getMessage(), 'showPopup' => false];
        }
    }
    ...
    public function getByWorkOrder($woNumber)
    {
        try {
            ...
            $stmt = $this->db->prepare($query);
            $stmt->bindParam(':wo_number', $woNumber, PDO::PARAM_STR);
            $stmt->execute();

            return ['data' => $stmt->fetchAll(PDO::FETCH_ASSOC), 'showPopup' => false];

        } catch (PDOException $e) {
            return ['error' => 'Error fetching assets by work order: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            return ['error' => 'Error fetching assets by work order: ' . $e->getMessage(), 'showPopup' => false];
        }
    }
    ...
    public function getCreationStats($dateFrom = null, $dateTo = null)
    {
        try {
            ...
            return ['error' => 'Error fetching creation statistics: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            return ['error' => 'Error fetching creation statistics: ' . $e->getMessage(), 'showPopup' => false];
        }
    }
    ...
    public function getLastUnusedSerialNumber()
    {
        try {
            ...
            return ['error' => 'Error fetching last unused serial number: ' . $e->getMessage(), 'showPopup' => false];
        } catch (\Exception $e) {
            return ['error' => 'Error fetching last unused serial number: ' . $e->getMessage(), 'showPopup' => false];
        }
    }
