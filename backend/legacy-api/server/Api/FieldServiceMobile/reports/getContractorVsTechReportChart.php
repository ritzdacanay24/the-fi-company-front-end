...
$mainQry = "
    select count(*) value
        ...
        , case when b.contractor_code IS NOT NULL THEN 'Contractor' ELSE 'Tech' END label
        , case when b.contractor_code IS NOT NULL THEN '#22afb1' ELSE '#2271B1' END background_color
    from fs_scheduler a 
