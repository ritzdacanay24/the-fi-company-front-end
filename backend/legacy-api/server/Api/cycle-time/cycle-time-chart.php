...
//alldata 
$mainQry = "
        SELECT a.*, b.*, c.*, ROUND(a.open_qty * cycleTime,2) ext_cycle_time, IFNULL(c.employees, 11) employees, week(wr_due_by, 1) week, year(wr_due_by) year
...
echo $dbConnect->json_encode(array("chart" => $chartData1, "allData" => $allData));
