...
try {
    ...
    $insertStmt = $db->prepare("
        ...
        (id, assignment_id, expected_serials, expected_ul, session_status, expires_at, created_at, serials_expected)
        VALUES (?, ?, ?, ?, 'active', ?, NOW(), ?)
    ");
    $insertStmt->execute([$sessionId, $assignmentId, $expectedSerialsJson, $expectedUl, $expiresAt, $serialsExpected]);
