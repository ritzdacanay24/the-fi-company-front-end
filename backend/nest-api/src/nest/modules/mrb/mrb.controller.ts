...
export class MrbController {
  constructor(private readonly service: MrbService) {}
  ...
  @Get('getQirForMrb')
  async getQirForMrb(@Query('id', ParseIntPipe) id: number) {
    return this.service.getQirForMrb(id);
  }
}
