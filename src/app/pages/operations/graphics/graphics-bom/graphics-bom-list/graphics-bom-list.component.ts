    ...
    columnDefs: any = [
        ...
        , {
            ...
            children: [
                ...
                , { field: 'DI_Product_SQL', headerName: 'DI Product SQL', filter: 'agMultiColumnFilter' }
                , { field: 'Image_Data', headerName: 'Image Data', filter: 'agMultiColumnFilter' }
                , { field: 'Manufacturer', headerName: 'Manufacturer', filter: 'agMultiColumnFilter' }
                , { field: 'Date_Purchased', headerName: 'Date Purchased', filter: 'agMultiColumnFilter' }
                , { field: 'Age_In_Years', headerName: 'Age In Years', filter: 'agMultiColumnFilter' }
                , { field: 'Serial_Number', headerName: 'Serial Number', filter: 'agMultiColumnFilter' }
                , { field: 'Purchased_From', headerName: 'Purchased From', filter: 'agMultiColumnFilter' }
                , { field: 'Category', headerName: 'Category', filter: 'agMultiColumnFilter' }
                , { field: 'Catalog_Item', headerName: 'Catalog Item', filter: 'agMultiColumnFilter' }
                , { field: 'Taxable', headerName: 'Taxable', filter: 'agMultiColumnFilter' }
                , { field: 'Keywords', headerName: 'Keywords', filter: 'agMultiColumnFilter' }
                , { field: 'Location', headerName: 'Location', filter: 'agMultiColumnFilter' }
                , { field: 'Cost', headerName: 'Cost', filter: 'agMultiColumnFilter' }
                , { field: 'Reorder_Level', headerName: 'Reorder Level', filter: 'agMultiColumnFilter' }
                , { field: 'Price', headerName: 'Price', filter: 'agMultiColumnFilter' }
                , { field: 'Unit_Weight', headerName: 'Unit Weight', filter: 'agMultiColumnFilter' }
                , { field: 'margin', headerName: 'Margin', filter: 'agMultiColumnFilter' }
                , { field: 'Status', headerName: 'Status', filter: 'agMultiColumnFilter' }
                , { field: 'Unit_Dimensions', headerName: 'Unit Dimensions', filter: 'agMultiColumnFilter' }
            ]
        }
        , {
            ...
            children: [
                ...
                , { field: 'DD1_2', headerName: '# Images', filter: 'agMultiColumnFilter' }
                , { field: 'DD1_3', headerName: 'DD1_3', filter: 'agMultiColumnFilter' }
                , { field: 'DD1_4', headerName: 'DD1_4', filter: 'agMultiColumnFilter' }
                , { field: 'DD1_5', headerName: 'TIF Size', filter: 'agMultiColumnFilter' }
                , { field: 'DD1_6', headerName: 'DD1_6', filter: 'agMultiColumnFilter' }
                , { field: 'DD1_7', headerName: 'Assembly Notes', filter: 'agMultiColumnFilter' }
            ]
        }
        , {
            headerName: 'Production Info',
            children: [
                { field: 'DD2_1', headerName: 'Substrate', filter: 'agMultiColumnFilter' }
                ...
                , { field: 'DD2_6', headerName: 'Production', filter: 'agMultiColumnFilter' }
        ...
        , {
            ...
            children: [
                { field: 'DD3_1', headerName: '1st Surf Lam', filter: 'agMultiColumnFilter' }
                , { field: 'DD3_2', headerName: '2nd Surf Lam', filter: 'agMultiColumnFilter' }
                , { field: 'DD3_3', headerName: 'Mounting', filter: 'agMultiColumnFilter' }
                ...
                , { field: 'DD3_8', headerName: 'Cutting Type', filter: 'agMultiColumnFilter' }
                , { field: 'DD3_9', headerName: 'Template/Die', filter: 'agMultiColumnFilter' }
            ]
        }
        , { field: 'Date_Created', headerName: 'Date Created', filter: 'agMultiColumnFilter' }
        , { field: 'Date_Modified', headerName: 'Date Modified', filter: 'agMultiColumnFilter' }
        , { field: 'UserName_Created', headerName: 'Username Created', filter: 'agMultiColumnFilter' }
        , { field: 'UserName_Modified', headerName: 'Username Modified', filter: 'agMultiColumnFilter' }
    ];
