...
export class GraphicsDemandComponent implements OnInit {
  ...
  columnDefs: ColDef[] = [
    ...
    },
    {
      ...
      valueFormatter: (params) => this.formatNumber(params.data.qtyNeeded),
    },
    ...
    {
      field: "checkedId",
      headerName: "Checked Id",
      filter: "agTextColumnFilter",
      hide: true,
    },
    {
      field: "salesOrderQty",
      headerName: "Sales Order Qty",
      filter: "agTextColumnFilter",
      valueFormatter: (params) => this.formatNumber(params.data.salesOrderQty),
    },
    {
      field: "qtyPer",
      headerName: "Component Qty Per",
      filter: "agTextColumnFilter",
      valueFormatter: (params) => this.formatNumber(params.data.qtyPer),
    },
    {
      field: "parentQtyPer",
      headerName: "Parent Qty Per",
      filter: "agTextColumnFilter",
      valueFormatter: (params) => this.formatNumber(params.data.parentQtyPer),
    },
    ...
    {
      field: "graphicsStatus",
      headerName: "Graphics Status",
      filter: "agSetColumnFilter",
    },
    {
      field: "graphicsSalesOrder",
      headerName: "Graphics Sales #",
      filter: "agTextColumnFilter",
      hide: true,
    },
    {
