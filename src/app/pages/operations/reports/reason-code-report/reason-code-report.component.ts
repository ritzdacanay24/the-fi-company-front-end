...
import { ReasonCodeReportChartReportChartComponent } from './reason-code-report-chart/reason-code-report-chart.component';
...
@Component({
  ...
  imports: [
    SharedModule,
    AgGridModule,
    ReasonCodeReportChartReportChartComponent,
    DateRangeComponent
  ],
...
export class ReasonCodeReportComponent implements OnInit {
  constructor(
