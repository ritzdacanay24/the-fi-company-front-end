...
export class BillAndHoldLabelModalService {
    ...
    open(data) {
        let modalRef = this.modalService.open(BillAndHoldLabelModalComponent, { size: 'md' });
...
@Component({
    ...
    selector: 'app-bill-and-hold-label-modal',
    templateUrl: './bill-and-hold-label-modal.component.html',
    styleUrls: []
})

export class BillAndHoldLabelModalComponent implements OnInit {
