...
export class IgtTransferListComponent implements OnInit {
  ...
  columnDefs:any = [
    ...
    { field: 'transfer_reference', headerName: 'Transfer Reference', filter: 'agMultiColumnFilter' },
    { field: 'transfer_reference_description', headerName: 'Transfer Reference Description', filter: 'agMultiColumnFilter' },
    { field: 'date', headerName: 'Date', filter: 'agMultiColumnFilter' },
    { field: 'from_location', headerName: 'From Location', filter: 'agMultiColumnFilter' },
    { field: 'to_location', headerName: 'To Location', filter: 'agMultiColumnFilter' },
