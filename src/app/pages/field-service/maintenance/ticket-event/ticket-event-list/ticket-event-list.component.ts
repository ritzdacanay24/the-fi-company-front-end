...
@Component({
  ...
  selector: 'app-ticket-event-list',
  templateUrl: './ticket-event-list.component.html',
})
export class TicketEventListComponent implements OnInit {

  constructor(
    public api: TicketEventService,
  ...
  columnDefs: any = [
    ...
    {
      field: 'icon', headerName: 'Icon', filter: 'agMultiColumnFilter',
      cellRenderer: (params) => {
        return `<i style="font-size:20px;" class="${params.value}"></i>`
      }
    },
    { field: 'description', headerName: 'Description', filter: 'agMultiColumnFilter' },
    { field: 'event_type', headerName: 'Event Type', filter: 'agMultiColumnFilter' },
    { field: 'isEvent', headerName: 'Is Event', filter: 'agMultiColumnFilter' },
    { field: 'isTravel', headerName: 'Is Travel', filter: 'agMultiColumnFilter' },
    { field: 'isBreak', headerName: 'Is Break', filter: 'agMultiColumnFilter' },
