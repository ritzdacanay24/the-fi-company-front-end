...
@Component({
  ...
  selector: 'app-ticket-event-report-chart',
  templateUrl: `./ticket-event-report-chart.component.html`,
})
export class TicketEventReportChartComponent implements OnInit {
