...
export class RequestsListComponent implements OnInit {
  ...
  columnDefs: ColDef[] = [
    ...
    { field: "id", headerName: "Request ID", filter: "agMultiColumnFilter" },
    {
      ...
      cellRenderer: (params) => {
        return params.data.fs_scheduler_id || params.data.active == null
          ? "-"
          : params.value;
      },
      cellClass: (params) => {
    ...
    {
      field: "eyefi_customer_sign_part",
      headerName: "Eyfi Customer Sign Part",
      filter: "agMultiColumnFilter",
    },
    {
      field: "licensing_required",
      headerName: "Licensing Required",
      filter: "agMultiColumnFilter",
    },
    {
      field: "onsite_customer_name",
      headerName: "Onsite Customer Name",
      filter: "agMultiColumnFilter",
    },
    {
      field: "onsite_customer_phone_number",
      headerName: "Onsite Customer Phone Number",
      filter: "agMultiColumnFilter",
    },
    {
      field: "po_number",
    ...
    {
      field: "type_of_sign",
      headerName: "Type Of Sign",
      filter: "agMultiColumnFilter",
    },
    {
      field: "bolt_to_floor",
      headerName: "Bolt To Floor",
      filter: "agMultiColumnFilter",
    },
  ...
  async onCustomerChange(row) {
    ...
    try {
      this.isLoading = true;
      let data = await this.api.getChart(
        this.dateFrom,
        this.dateTo,
