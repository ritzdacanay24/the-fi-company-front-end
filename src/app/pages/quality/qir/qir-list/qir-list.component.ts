...
export class QirListComponent implements OnInit {
  ...
  columnDefs: any = [
    ...
    { field: "eyefiPartNumber", headerName: "Eyefi Part Number", filter: "agTextColumnFilter" },
    { field: "eyefiSerialNumber", headerName: "Eyefi Serial Number", filter: "agTextColumnFilter" },
    { field: "failureType", headerName: "Failure Type", filter: "agTextColumnFilter" },
    { field: "platformType", headerName: "Platform Type", filter: "agTextColumnFilter" },
    ...
    { field: "qtyAffected", headerName: "Qty Affected", filter: "agTextColumnFilter" },
    { field: "qtyAffected1", headerName: "Qty Affected 1", filter: "agTextColumnFilter" },
    { field: "stakeholder", headerName: "Stakeholder", filter: "agTextColumnFilter" },
