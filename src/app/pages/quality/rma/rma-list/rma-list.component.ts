...
export class RmaListComponent implements OnInit {
  ...
  columnDefs:any = [
    ...
    { field: 'customerComment', headerName: 'Customer Comment', filter: 'agMultiColumnFilter', maxWidth: 200 },
    { field: 'dateIssued', headerName: 'Date Issued', filter: 'agMultiColumnFilter' },
    { field: 'disposition', headerName: 'Disposition', filter: 'agMultiColumnFilter' },
    { field: 'failureCode', headerName: 'Failure Code', filter: 'agMultiColumnFilter' },
    { field: 'notes', headerName: 'Notes', filter: 'agMultiColumnFilter', maxWidth: 200 },
    { field: 'orderNumber', headerName: 'Order Number', filter: 'agMultiColumnFilter' },
    ...
    { field: 'returnMethod', headerName: 'Return Method', filter: 'agMultiColumnFilter' },
    { field: 'returnType', headerName: 'Return Type', filter: 'agMultiColumnFilter' },
    { field: 'rmaNumber', headerName: 'RMA Number', filter: 'agMultiColumnFilter' },
    { field: 'status', headerName: 'Status', filter: 'agMultiColumnFilter' },
    { field: 'tag_qn_number', headerName: 'Tag QN Number', filter: 'agMultiColumnFilter' },
