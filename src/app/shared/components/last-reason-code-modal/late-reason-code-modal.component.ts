...
export class LateReasonCodeModalService {
    ...
    open(key: any, miscData: any, soLineNumber: any, department = "") {
        let modalRef = this.modalService.open(LateReasonCodeModalComponent, { size: 'md', fullscreen: false, backdrop: 'static', scrollable: true, centered: true, keyboard: false });
