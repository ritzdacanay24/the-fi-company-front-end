...
@Component({
  ...
  selector: 'app-license-entity-search',
  templateUrl: `./license-entity-search.component.html`,
})
export class LicenseEntitySearchComponent implements OnInit {
  ...
  private getList() {
    this.data$ = concat(
      ...
      this.dataInput$.pipe(
        ...
        switchMap(term => this.api.searchLicense(term).pipe(
